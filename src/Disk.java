class Disk implements Comparable<Disk> {
    ...
    /**
     * Compares one disk to another to determine which is larger, and therefore which can be moved
     * on top of the other.
     * 
     * @param other is a reference to the disk we are comparing this one to.
     * @return a positive number when this.size > other.size, a negative number when this.size <
     *         other.size, or zero when this.size == other.size, or other is null.
     */
    @Override
    ...
    /**
     * The string representation of this disk object includes its integer size surrounded by size-1
     * equals characters (=) on each side, and enclosed within angle brackets (<>). For example:
     * size 1: "<1>" size 2: "<=2=>" size 3: "<==3==>"
     * 
